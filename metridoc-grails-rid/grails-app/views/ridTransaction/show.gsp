            ...
            <div id="show-ridTransaction" class="content scaffold-show" role="main">
                ...
                <table border="0"
                    ...
                    <tr align="center">
                        ...
                        <td colspan="2">
                            <span id="dateOfConsultation-label" class="property-label"><g:message
                                    code="ridTransaction.dateOfConsultation.label"
                                    default="Date Of Consultation"/></span>
                            :
                    ...
                    <tr align="center">
                        <td>
                            <span id="userName-label" class="property-label"><g:message
                                    code="ridTransaction.userName.label"
                        ...
                        <td colspan="2">
                            <span id="interactOccurrences-label" class="property-label"><g:message
                                    code="ridTransaction.interactOccurrences.label"
                                    default="Interact Occurrences"/></span>
                            :<br/>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <span id="userGoal-label" class="property-label"><g:message
                                    code="ridTransaction.userGoal.label"
                        ...
                        <td>
                            <span id="prepTime-label" class="property-label"><g:message
                                    code="ridTransaction.prepTime.label"
            ...
            <tr align="center">
                ...
                <td>
                    <span id="instructionalMaterials-label" class="property-label"><g:message
                            code="ridTransaction.instructionalMaterials.label"
                            default="Instructional Materials"/></span>
                    :<br/>
